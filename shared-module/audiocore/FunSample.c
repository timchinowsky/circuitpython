...
void common_hal_audioio_funsample_set_sample_rate(audioio_funsample_obj_t *self,
    uint32_t sample_rate) {
    self->sample_rate = sample_rate;
}
...
void audioio_funsample_reset_buffer(audioio_funsample_obj_t *self,
...
audioio_get_buffer_result_t audioio_funsample_get_buffer(audioio_funsample_obj_t *self,
    bool single_channel_output,
    uint8_t channel,
    uint8_t **buffer,
...
void audioio_funsample_get_buffer_structure(audioio_funsample_obj_t *self, bool single_channel_output,
